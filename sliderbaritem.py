...
patientItems = [
                ...
                {"isTitle": False,"name":"发热门诊预约","icon":"grid-fill","filename":"#","url":'patient.patient'}
]

chiefItems = [
                {"isTitle": False,"name":"主頁","icon":"grid-fill","filename":"chief.html","url":'chief.chief'},
                {"isTitle": True,"name":"功能"},
                {"isTitle": False,"name":"查看所有预约","icon":"grid-fill","filename":"doctor_appointments.html","url":'chief.chief'},
                ...
                {"isTitle": False,"name":"查看下属医生历史看诊","icon":"grid-fill","filename":"#","url":'chief.chief'},
                {"isTitle": False,"name":"修改个人信息","icon":"grid-fill","filename":"chief_change_inf.html","url":'chief.change_inf'},
                {"isTitle": False,"name":"修改科室描述","icon":"grid-fill","filename":"#","url":'chief.chief'},
                {"isTitle": False, "name": "修改下属医生信息", "icon": "grid-fill", "filename": "#", "url": 'chief.chief'},
