...
def diagnosis(username):
    ...
    return render_template('fever_doctor_diagnosis.html',ranking =ranking,rankchin = rankchin,realname = realname,name=username, sidebarItems=fever_doctorItems,records=records,hav=len(appointments),finishdic = finishdic,total = total_app_num,undo = undo_app_num,done = done_app_num, riskdic = risk_patient_dic)
